            ...
            <div class="row align-items-center text-white">
              ...
              (here your can place your description text)
                ...
                <div class="col-md-6 intros text-end">
                    <div class="video-box">
                        <img src="{{asset('frontend_assets/images/arts/intro-section-illustration.png')}}" alt="video illutration" class="img-fluid">
            ...
            <div class="row">
                <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src="{{asset('frontend_assets/images/campanies/campany-1.png')}}" alt="Campany 1 logo" title="Campany 1 Logo" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src="{{asset('frontend_assets/')}}images/campanies/campany-2.png" alt="Campany 2 logo" title="Campany 2 Logo" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src="{{asset('frontend_assets/images/campanies/campany-3.png')}}" alt="Campany 3 logo" title="Campany 3 Logo" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src="{{asset('frontend_assets/images/campanies/campany-4.png')}}" alt="Campany 4 logo" title="Campany 4 Logo" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src="{{asset('frontend_assets/images/campanies/campany-5.png')}}" alt="Campany 5 logo" title="Campany 5 Logo" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-4 col-lg-2">
                    <div class="campanies__logo-box shadow-sm">
                        <img src="{{asset('frontend_assets/images/campanies/campany-6.png')}}" alt="Campany 6 logo" title="Campany 6 Logo" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
                    <div class="services__pic">
                        <img src="{{asset('frontend_assets/images/services/service-1.png')}}" alt="marketing illustration" class="img-fluid">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
                    <div class="services__pic">
                        <img src="{{asset('frontend_assets/images/services/service-2.png')}}" alt="web development illustration" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
                    <div class="services__content">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
                    <div class="services__pic">
                        <img src="{{asset('frontend_assets/images/services/service-3.png')}}" alt="cloud hosting illustration" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="testimonials__picture">
                                <img src="{{asset('frontend_assets/images/testimonials/client-1.jpg')}}" alt="client-1 picture" class="rounded-circle img-fluid">
                            </div>
                            <!-- client name & role  -->
                        ...
                        <div class="carousel-item">
                            ...
                            <!-- client picture  -->
                            <div class="testimonials__picture">
                                <img src="{{asset('frontend_assets/images/testimonials/client-2.jpg')}}" alt="client-2 picture" class="rounded-circle img-fluid">
                            </div>
                            <!-- client name & role  -->
                            <div class="testimonials__name">
                                <h3>Joy Marete</h3>
                        ...
                        <div class="carousel-item">
                            ...
                            <!-- client picture  -->
                            <div class="testimonials__picture">
                                <img src="{{asset('frontend_assets/images/testimonials/client-3.jpg')}}" alt="client-3 picture" class="rounded-circle img-fluid">
                            </div>
                            <!-- client name & role  -->
                            <div class="testimonials__name">
                        ...
                        <div class="carousel-item">
                            ...
                            <!-- client picture  -->
                            <div class="testimonials__picture">
                                <img src="{{asset('frontend_assets/images/testimonials/client-4.jpg')}}" alt="client-4 picture" class="rounded-circle img-fluid">
                            </div>
                            <!-- client name & role  -->
                            <div class="testimonials__name">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-1.jpg')}}" alt="portfolio 1 image" title="portfolio 1 picture"
                             class="img-fluid">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-2.jpg')}}" alt="portfolio 2 image" title="portfolio 2 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-3.jpg')}}" alt="portfolio 3 image" title="portfolio 3 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-4.jpg')}}" alt="portfolio 4 image" title="portfolio 4 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-5.jpg')}}" alt="portfolio 5 image" title="portfolio 5 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-6.jpg')}}" alt="portfolio 6 image" title="portfolio 6 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-7.jpg')}}" alt="portfolio 7 image" title="portfolio 7 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-8.jpg')}}" alt="portfolio 8 image" title="portfolio 8 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="portfolio-box shadow">
                        <img src="{{asset('frontend_assets/images/portfolio/portfolio-9.jpg')}}" alt="portfolio 9 image" title="portfolio 9 picture"
                             class="img-fluid">
                        <div class="portfolio-info">
                            <div class="caption">
